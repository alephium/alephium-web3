...
describe('AssetOutputCodec', () => {
  it('should throw for p2pk asset outputs', () => {
    ...
    expect(() => AssetOutputCodec.toFixedAssetOutput(new Uint8Array(32), assetOutput, 0)).toThrow(
      'Unexpected output script type: P2PK'
    )
  })

  it('should throw for p2hmpk asset outputs', () => {
    ...
    expect(() => AssetOutputCodec.toFixedAssetOutput(new Uint8Array(32), assetOutput, 0)).toThrow(
      'Unexpected output script type: P2HMPK'
    )
  })
})

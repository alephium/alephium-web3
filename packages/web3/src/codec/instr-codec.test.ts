...
describe('Encode & decode instrs', function () {
  it('should encode & decode instrs', function () {
    const instrs: [instr.Instr, string][] = [
      ...
      [instr.U256ModSub, '36'],
      [instr.U256ModMul, '37'],
      [instr.NumericBitAnd, '38'],
      [instr.NumericBitOr, '39'],
      [instr.NumericXor, '3a'],
      [instr.NumericSHL, '3b'],
      [instr.NumericSHR, '3c'],
      [instr.I256ToU256, '3d'],
      ...
      [instr.VerifySignature, '8d'],
      [instr.GetSegregatedWebAuthnSignature, '8e'],
      [instr.DevInstr(0), '8f00'],
      [instr.I256RoundInfinityDiv, '90'],
      [instr.U256RoundInfinityDiv, '91'],

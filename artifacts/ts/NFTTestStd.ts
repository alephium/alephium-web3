...
import { NFTTestStdContractArtifact, getContractByCodeHash } from "./contracts";
import {
  AddStruct1,
  AddStruct2,
  Balances,
...
> {
  ...
  stateForTest(
    initFields: NFTTestStdTypes.Fields,
    asset?: Asset,
    address?: string
  ) {
...
export const NFTTestStd = new Factory(NFTTestStdContractArtifact);
